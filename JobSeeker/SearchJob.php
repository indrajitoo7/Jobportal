...
$row_Recordset3 = $Recordset3->fetch_array(MYSQLI_ASSOC);
$totalRows_Recordset3 = mysqli_num_rows($Recordset3);


$Recordset4 = $conn->query("SELECT distinct CompanyName FROM job_master");
$totalRows_Recordset4 = mysqli_num_rows($Recordset4);
$row_Recordset4 = $Recordset4->fetch_array(MYSQLI_ASSOC);

// mysql_select_db($database_job, $job);
$query_Recordset5 = "SELECT distinct JobTitle FROM job_master";
$Recordset5 = $conn->query($query_Recordset5);
$row_Recordset5 = $Recordset5->fetch_array(MYSQLI_ASSOC);
...
$query_Recordset2 = sprintf("SELECT * FROM job_master WHERE MinQualification = %s and CompanyName=%s and JobTitle=%s", GetSQLValueString($colname_Recordset2, "text", $conn, "", ""), GetSQLValueString($colname2_Recordset2, "text", $conn, "", ""), GetSQLValueString($colname3_Recordset2, "text", $conn, "", ""));
                ...
                <tr>
                  ...
                  <td><label>
                      <select name="cmbCompany" id="cmbCompany">
                        ...
                        <?php
                        } while ($row_Recordset4 = $Recordset4->fetch_array(MYSQLI_ASSOC));
                        $rows = mysqli_num_rows($Recordset4);
                        if ($rows > 0) {
                          mysqli_data_seek($Recordset4, $rows);
                          $row_Recordset4 = $Recordset4->fetch_array(MYSQLI_ASSOC);
                        }
                        ?>
                      </select>
                ...
                <tr>
                  ...
                  <td><label>
                      <select name="cmbArea" id="cmbArea">
                        ...
                        <?php
                        } while ($row_Recordset5 = $Recordset5->fetch_array(MYSQLI_ASSOC));
                        $rows = mysqli_num_rows($Recordset5);
                        if ($rows > 0) {
                          mysqli_data_seek($Recordset5, $rows);
                          $row_Recordset5 = $Recordset5->fetch_array(MYSQLI_ASSOC);
                        }
                        ?>
                      </select>
              ...
              <tr>
                <td width="100%">&nbsp;
                  ...
                  if ($totalRows_Recordset2 != 0) {
                    ...
                    <?php } while ($row_Recordset2 = $Recordset2->fetch_array(MYSQLI_ASSOC));
